...
cnf(goal_2, negated_conjecture, (product(X1,X5,X0))).
cnf(goal_3, negated_conjecture, (product(domain(X0),domain(X0),domain(X0)))).
cnf(goal_4, negated_conjecture, (product(domain(X0),domain(X0),codomain(domain(X0))))).
cnf(goal_5, negated_conjecture, (identity_map(domain(X0)))).
cnf(goal_6, negated_conjecture, (defined(domain(X0),domain(X0)))).
cnf(goal_7, negated_conjecture, (product(X0,X5,X5))).
cnf(goal_8, negated_conjecture, (product(X0,X5,X0))).
cnf(goal_9, negated_conjecture, (product(X0,X1,X3))).
cnf(goal_10, negated_conjecture, (product(X5,X5,X5))).
cnf(goal_11, negated_conjecture, (product(X0,X0,domain(X0)))).
cnf(goal_12, negated_conjecture, (product(X3,X5,X5))).
cnf(goal_13, negated_conjecture, (product(domain(X0),X0,domain(X0)))).
cnf(goal_14, negated_conjecture, (identity_map(X0))).
cnf(goal_15, negated_conjecture, (identity_map(X5))).
cnf(goal_16, negated_conjecture, (defined(X5,X5))).
cnf(goal_17, negated_conjecture, (~product(domain(X0),domain(X0),compose(X0,X1)))).
