...
cnf(goal_1, negated_conjecture, (defined(X1,X1))).
cnf(goal_2, negated_conjecture, (product(domain(X1),X1,X1))).
cnf(goal_3, negated_conjecture, (product(X1,X1,domain(X1)))).
cnf(goal_4, negated_conjecture, (product(domain(X1),X1,domain(X1)))).
cnf(goal_5, negated_conjecture, (identity_map(X1))).
cnf(goal_6, negated_conjecture, (~defined(X1,X1))).
cnf(goal_7, negated_conjecture, (product(X1,X1,X1))).
cnf(goal_8, negated_conjecture, (defined(domain(X1),X1))).
