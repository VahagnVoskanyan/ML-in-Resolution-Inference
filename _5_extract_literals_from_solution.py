...
if __name__ == "__main__":
    ...
    problem_folder = f"{constants.RESOLVABLE_PAIRS}"    # Folder containing the .jsonl files
    output_folder = f"{constants.SOLVED_PROBLEM}"        # Folder containing the _solved.txt files
